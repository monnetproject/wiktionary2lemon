...
/**
 * Similarity measure based on difference between average number of direct children in the calculations (for monetary items) or presentations (for string items) of the entities.
 * 
 * @author Dennis Spohr
 *
 */
