...
public class AverageAverageSubstring implements EntitySimilarityMeasure {
	...
	public AverageAverageSubstring() {
	}
    ...
    public void configure(Properties properties) {
		...
		this.includePuns = SimilarityUtils.getIncludePuns(properties.getProperty("include_puns", "true"));
    }
