...
/**
 * Similarity measure based on difference between minimum ratio of credit/debit items in elementary summation items in the calculations of the entities.
 * 
 * @author Dennis Spohr
 *
 */
@Component(provide=EntitySimilarityMeasure.class)
public class MinimumRatioCreditDebitElementarySummationItems implements EntitySimilarityMeasure {
	...
	public MinimumRatioCreditDebitElementarySummationItems() {
	}
