...
/**
 * Similarity measure based on difference between maximum ratio of credit/debit items in elementary summation items in the calculations of the entities.
 * 
 * @author Dennis Spohr
 *
 */
...
public class MaximumRatioCreditDebitElementarySummationItems implements EntitySimilarityMeasure {
	...
	public MaximumRatioCreditDebitElementarySummationItems() {
	}
