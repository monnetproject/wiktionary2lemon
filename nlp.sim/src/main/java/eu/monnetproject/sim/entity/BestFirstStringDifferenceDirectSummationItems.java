...
/**
 * Similarity measure based on best first string difference between direct summation items in the calculations of the entities.
 * 
 * @author Dennis Spohr
 *
 */
@Component(provide=EntitySimilarityMeasure.class)
public class BestFirstStringDifferenceDirectSummationItems implements EntitySimilarityMeasure {
	...
	public BestFirstStringDifferenceDirectSummationItems() {
	}
