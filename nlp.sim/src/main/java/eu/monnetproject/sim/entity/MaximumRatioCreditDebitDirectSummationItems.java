...
/**
 * Similarity measure based on difference between maximum ratio of credit/debit items in direct summation items in the calculations of the entities.
 * 
 * @author Dennis Spohr
 *
 */
@Component(provide=EntitySimilarityMeasure.class)
public class MaximumRatioCreditDebitDirectSummationItems implements EntitySimilarityMeasure {
	...
	public MaximumRatioCreditDebitDirectSummationItems() {
	}
