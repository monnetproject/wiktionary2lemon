...
public class MaximumMaximumLevenshtein implements EntitySimilarityMeasure {
	...
	public MaximumMaximumLevenshtein() {
	}
	...
	public double getScore(Entity srcEntity, Entity tgtEntity) {
		...
		for (Language language : this.languages) {
			...
			Collection<String> srcLabels = srcMap.get(language.getLanguageOnly());
			Collection<String> tgtLabels = tgtMap.get(language.getLanguageOnly());
